                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <a href="javascript:void(0)">
                                <img src="asset/img/client/c1.png" alt="img">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="javascript:void(0)">
                                <img src="asset/img/client/c2.png" alt="img">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="javascript:void(0)">
                                <img src="asset/img/client/c3.png" alt="img">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="javascript:void(0)">
                                <img src="asset/img/client/c4.png" alt="img">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="javascript:void(0)">
                                <img src="asset/img/client/c5.png" alt="img">
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div
                ...
                <a href="index.html" class="footer-logov1 m-md-0 m-auto">
                    <img src="asset/img/my/logo.png" alt="img">
                </a>
...
<script src="{{asset('/asset/js/vanilla-tilt.min.js')}}"></script>
